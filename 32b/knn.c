...
void read_files(char const *argv[], base_type *train_base) {
    ...
    // train_base->base = (__v32f *)malloc(sizeof(__v32f) * training_instances * n_vectors * VSIZE);
...
__v32f **create_mask(int n_instances) {
    // __v32f **mask = (__v32f **)malloc(sizeof(__v32f *) * n_instances);
    __v32f **mask = (__v32f **)calloc(n_instances, sizeof(__v32f *));
    for (int i = 0; i < n_instances; ++i) {
        // mask[i] = (__v32f *)malloc(sizeof(__v32f) * VSIZE);
...
void classification(char const *argv[], base_type *train_base) {
    ...
    // test_base.base = (__v32f *)malloc(sizeof(__v32f) * v_tesize * VSIZE);
    ...
    // __v32f **e_distance = (__v32f **)malloc(sizeof(__v32f *) * n_instances);
    for (i = 0; i < n_instances; ++i) {
        e_distance[i] = (__v32f *)calloc(training_instances, sizeof(__v32f));
        // e_distance[i] = (__v32f *)malloc(sizeof(__v32f) * training_instances);
    }
    __v32f *partial_sub = (__v32f *)calloc(v_tesize * VSIZE, sizeof(__v32f));
    // __v32f *partial_sub = (__v32f *)malloc(sizeof(__v32f) * v_tesize * VSIZE);
    __v32f *partial_mul = (__v32f *)calloc(v_tesize * VSIZE, sizeof(__v32f));
